      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Napište nám. První konzultace je zdarma a nezavazuje vás k ničemu.
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={handleInputChange}
                  rows={4}
                  placeholder="Popište nám váš projekt nebo požadavky..."
                />
              </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Preferujete telefonní rozhovor? Zavolejte nám nebo napište e-mail. 
                Rádi s vámi probereme detaily vašeho projektu.
              </p>
            </div>
            ...
            <div className="bg-emerald-50 rounded-xl p-6">
              ...
              <p className="text-emerald-700 text-sm">
                Na vaše dotazy odpovídáme obvykle do 24 hodin. 
